...
Route::post('/movies/{movie}/increment_views', 'MovieController@incrementViews')->name('movies.increment_views');
Route::post('/movies/{movie}/toggle_favourite', 'MovieController@toggleFavourite')->name('movies.toggle_favourite');
